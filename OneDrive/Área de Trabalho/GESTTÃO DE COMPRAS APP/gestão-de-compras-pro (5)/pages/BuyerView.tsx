                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input 
                                ...
                                onChange={async (e) => {
                                    ...
                                    try {
                                        await updateDoc(doc(db, `${BASE_PATH}/companies/${companyId}/app_config`, 'main'), {
                                            useRemotePrinter: isChecked
                                        });
                                        alert(isChecked ? "Servidor Remoto ATIVADO com sucesso!" : "Servidor Remoto DESATIVADO com sucesso!");
                                    } catch (err) {
                                        console.error(err);
                                        alert("ERRO ao salvar configuração: " + (err as any).message);
                                    }
                                }}
                            />
